...
<Type type="() => void" />
Function to submit current step.
...
Function to manually set errors on form fields.
...
Function to manually set form fields values.
...
<Type
  ...
  | 'values'"
/>
Function to reset form states and values.
