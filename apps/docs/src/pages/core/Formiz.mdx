...
This component defines form scope and manages form logic. It creates his own form if it's not connected to a [`useForm()`](/core/useForm).
...
By default, it is generated automatically. But for SSR rendering like in NextJS,
you may want to replace the automatically generated identifiers by a predictable
id.
...
<Type type="Object" />
Allow you to pass some initial values to the form. If a field is mounted, it will
